...
// console.log(users); // it will give me promise object
users.then((usersData) => {
    for (let user of usersData) {
        // console.log(user.name); // it will give me all users name
        // console.log(user); // it will give me all users
        let uid = user.userId;
        // console.log(uid); // it will give me all user ids
        let comments = fetchComments(uid);
        // console.log(comments); // it will give me all comments
        comments.then((commentsData) => {
            // console.log(commentsData); // it will give me all comments
        }).catch((error) => {
            console.log(error);
        });
    }
...
users.then((usersData) => {
    for (let user of usersData) {
        let uid = user.userId;
        let posts = fetchPosts(uid);
        // console.log(posts); // it will give me all posts
        posts.then((postsData) => {
            console.log(postsData); // it will give me all posts
        }).catch((error) => {
            console.log(error);
        })
    }
